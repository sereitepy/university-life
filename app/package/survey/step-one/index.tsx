...
export default function StepOne({ formData, setFormData }: StepOneProp) {
  ...
  return (
    <div className='flex flex-col gap-5 transition-all duration-300 ease-in-out'>
      <section className='flex flex-col gap-4 items-baseline justify-baseline'>
        <DialogTitle className='text-2xl'>1.&nbsp;&nbsp;Personal</DialogTitle>
      ...
      <section className='flex flex-col items-center justify-center gap-30 overflow-y-auto scroll-smooth pb-15'>
        ...
        <section
          className={`relative flex flex-col justify-center items-center gap-5 transition-all duration-300 ease-in-out
            ${formData.personal.age && 'opacity-50'}
            ${!formData.personal.age && 'scale-120'}
            `}
        >
        ...
        <section
          ...
          className={`flex flex-col justify-center items-center gap-5 transition-all duration-300 ease-in-out
            ${!formData.personal.age && 'opacity-50 cursor-not-allowed'}
            ${formData.personal.age && !formData.personal.gender && 'scale-120'}
            ${formData.personal.gender && 'opacity-50'}`}
        >
        ...
        <section
          ...
          id='grade-section'
          className={`flex flex-col justify-center items-center gap-5 transition-all duration-300 ease-in-out
            ${!formData.personal.gender && 'opacity-50 cursor-not-allowed'}
            ${
            ...
            ${formData.personal.grade && 'opacity-50'}
            `}
        >
        ...
        <section
          ref={highschoolRef}
          className={`flex flex-col justify-center items-center gap-5 transition-all duration-300 ease-in-out
            ${!formData.personal.grade && 'opacity-50 cursor-not-allowed'}
            ${
              formData.personal.grade &&
              !formData.personal.highschool &&
              'scale-120'
            }
            ${formData.personal.highschool && 'opacity-50'}
            `}
        >
        ...
        <section
          ref={gradYearRef}
          className={`flex flex-col justify-center items-center gap-5 transition-all duration-300 ease-in-out
            ${!formData.personal.highschool && 'opacity-50 cursor-not-allowed'}
            ${
              formData.personal.highschool &&
              !formData.personal.graduation_year &&
              'scale-120'
            }
            ${formData.personal.graduation_year && 'opacity-50'}
            `}
        >
        ...
        <section
          ...
          className={`flex flex-col justify-center items-center gap-5 transition-all duration-300 ease-in-out
            ...
            ${formData.personal.bacII_grade && 'opacity-50'}
            `}
        >
        ...
        <section
          ...
          className={`flex flex-col justify-center items-center gap-5 transition-all duration-300 ease-in-out
            ${!formData.personal.bacII_grade && 'opacity-50 cursor-not-allowed'}
            ${
              formData.personal.bacII_grade &&
              !formData.personal.academic_performance &&
              'scale-120'
            }
            ${formData.personal.academic_performance && 'opacity-50'}
            `}
        >
